...
public class Repository {
    ...
    public Optional<String> getUserCity(String username) {
    	return template.queryForList("select city from users where name=?", username).stream().map(x -> x.get("city").toString()).findFirst();
    }
